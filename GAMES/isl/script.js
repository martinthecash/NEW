document.addEventListener('DOMContentLoaded', () => {
  ...
  function showSignalModal(_0x161cb3) {
    _0x161bfb.textContent = 'СИГНАЛ' + _0x161cb3 + 'x', _0x7811cb.style.display = 'flex', setTimeout(() => {
  ...
  modal.style.display = 'none'; // по умолчанию скрыто
  ...
  modalTitle.textContent = 'СИГНАЛ';

  const modalX = document.createElement('div');
  modalX.className = 'modal-x';
  modalX.textContent = '2.5x';

  const modalText = document.createElement('div');
  modalText.className = 'modal-text';
  modalText.textContent = 'Cash Out!';
  ...
  modalButton.addEventListener('click', hideSignalModal);
  modal.addEventListener('click', (e) => {
    if (e.target === modal) hideSignalModal();
  });
...
rays.className = 'modal-rays';
modalContent.appendChild(rays);
  ...
  function _0x580e92() {
    ...
    console.log('Jump to platform #' + _0x32559d + ' with multiplier ' + _0x2d4b9e.dataset.coefficient), _0x466e01(_0x2d4b9e), window.targetPlatformIndex === _0x32559d && setTimeout(() => {
      ...
      showSignalModal(_0xa35c09), _0x28e965();
    }, 1000);
  }
  function _0x466e01(_0x56f99f) {
    ...
    console.log('Jump to position: X=' + _0x583aef + ', Y=' + _0x1f57f0 + ', platform dimensions: ' + _0x3142d5.width + 'x' + _0x3142d5.height), _0x28c097.style.transition = 'all 0.5s ease-out', _0x28c097.style.left = _0x583aef + 'px', _0x28c097.style.bottom = window.innerHeight - _0x1f57f0 - _0x3c9b44 + 'px', _0x204b3b = {
      ...
      _0x28c097.classList.add('jump-end'), setTimeout(() => {
        ...
        showSignalModal(_0x4c4e13), _0x28e965(), setTimeout(() => {
          _0x2a3abd();
        }, 1500);
      }, 300);
    }, 500);
  ...
  function _0x30b0a8() {
    ...
    showSignalModal(_0x4a80e7), _0x466e01(_0x2a1579);
  }
  function _0x368316() {
