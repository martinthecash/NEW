const _0x59d84d = {};
_0x59d84d.name = 'RED', _0x59d84d.image = 'images/red.png';
const _0x1695f9 = {};
_0x1695f9.name = 'BLACK', _0x1695f9.image = 'images/black.png';
const _0x9e12d8 = {};
_0x9e12d8.name = 'STAR', _0x9e12d8.image = 'images/star.png';``
...
function createBackgroundCell() {
  ...
  const _0x5540c3 = ['red', 'black', 'star'],
  ...
  setTimeout(() => {
    ...
    const _0x3ad048 = function () {
      ...
      function _0x4ebd53() {
        ...
        playResultSound(_0x137978), resultElement.innerHTML = 'Ставь на: <span>' + _0x137978 + '</span>', setTimeout(() => {
